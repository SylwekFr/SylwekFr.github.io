...
export const tabletopGames: TabletopGame[] = [
    {
        author: "Rebel",
        avatar: "https://www.rebelstudio.eu/images/logo/logo-black-notext.png",
        date: 2009,
    ...
    avatar: "https://12ax7web.s3.amazonaws.com/accounts/2/storefronts/2/unstablegames-logo-new.svg",
    date: 2017,
